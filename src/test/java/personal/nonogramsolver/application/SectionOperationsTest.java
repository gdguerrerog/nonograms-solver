...
public class SectionOperationsTest {
    ...
    public void testSpaces() {
        ...
        List<Space> spaces = ops.spaces();
        
        Assertions.assertEquals(1, spaces.size());
        
        assertSpace(new ArraySpace(new CellStatus[]{UNKNOWN, ENABLED, UNKNOWN}, 1), spaces.get(0));
        ...
        assertSpace(new ArraySpace(new CellStatus[]{UNKNOWN}, 0), spaces.get(0));
        assertSpace(new ArraySpace(new CellStatus[]{ENABLED, ENABLED}, 2), spaces.get(1));
        assertSpace(new ArraySpace(new CellStatus[]{UNKNOWN, ENABLED}, 5), spaces.get(2));
        assertSpace(new ArraySpace(new CellStatus[]{UNKNOWN}, 8), spaces.get(3));
    }
    ...
    public void testRemoveBorders() {
        ...
        Tuple2<Integer, SectionOperations> result = ops.removeBorders();
        
        Assertions.assertEquals(3, result.getT1());
        assertSection(new ArraySection(new Integer[]{2}, new CellStatus[]{UNKNOWN, ENABLED}), result.getT2().getSection());
    }
